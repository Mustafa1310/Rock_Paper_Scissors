...
rockButton = Button(mainWindow, width=20, text="ROCK!", bg="Red",fg="White" ,justify=CENTER,
                    command=rock)
paperButton = Button(mainWindow, width=20, text="PAPER!", bg="Blue", fg="White", justify=CENTER,
                     command=paper)
scissorsButton = Button(mainWindow, width=20, text="SCISSORS!", bg="Green", fg="White", justify=CENTER,
                        command=scissors)
